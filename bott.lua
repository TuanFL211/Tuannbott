...
function ChatbotScript:CreateGUI()
    ...
    PersonalityLayout.Parent = SettingsPanel

    local NormalBtn = Instance.new("TextButton")
    NormalBtn.Name = "NormalBtn"
    NormalBtn.Size = UDim2.new(0.3, 0, 0, 25)
    NormalBtn.Position = UDim2.new(0, 0, 0, 90)
    ...
    NormalBtn.Parent = SettingsPanel
    ...
    SweetBtn.Size = UDim2.new(0.3, 0, 0, 25)
    SweetBtn.Position = UDim2.new(0.33, 0, 0, 90)
    ...
    RudeBtn.Size = UDim2.new(0.3, 0, 0, 25)
    RudeBtn.Position = UDim2.new(0.66, 0, 0, 90)
    ...
    self:AddMessage("🤖 Chatbot Tuann Pro", "Xin chào! Tôi là bot của Tuann với tích hợp Gemini AI. Vui lòng cài đặt API Key trong Settings!", false)
...
function ChatbotScript:UpdatePersonalityUI()
    ...
    local NormalBtn = ChatbotUI.MainFrame.SettingsPanel.NormalBtn
    local SweetBtn = ChatbotUI.MainFrame.SettingsPanel.SweetBtn
    local RudeBtn = ChatbotUI.MainFrame.SettingsPanel.RudeBtn
...
function ChatbotScript:SetupEvents(MainFrame)
    ...
    local NormalBtn = SettingsPanel.NormalBtn
    local SweetBtn = SettingsPanel.SweetBtn
    local RudeBtn = SettingsPanel.RudeBtn
...
function ChatbotScript:CallGeminiAPI(message)
    if self.Config.GeminiAPIKey == "YOUR_GEMINI_API_KEY_HERE" then
